...
try:
    ...
    client = commands.Bot(command_prefix=prefix, help_command=None, case_insensitive=True, intents=intents)
    ...
    print(Fore.YELLOW + "[" + Fore.RESET + Fore.BLUE + "*" + Fore.RESET + Fore.YELLOW + "]" + Fore.RESET + Fore.RED + "Invalid token or you didn't enable intents for your bot")
    time.sleep(30)
